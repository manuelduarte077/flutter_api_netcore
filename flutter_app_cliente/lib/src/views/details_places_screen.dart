...
class DetailPlacesScreen extends StatelessWidget {
  ...
  DetailPlacesScreen(this.objLugar);
  ...
  Widget build(BuildContext context) {
    var marker = Marker(
      ...
      infoWindow:
          InfoWindow(title: objLugar.nombre, snippet: objLugar.descripcion),
      onTap: () {
        //codigo
      },
    );
          ...
          ListView(
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(objLugar.descripcion,
    ...
    return InkWell(
      ...
      onTap: () {
        if (idEvento == 1) {
          ...
          _irMapaStatic(
              "https://maps.googleapis.com/maps/api/staticmap?center=${objLugar.latitud},${objLugar.longitud}&zoom=15&size=400x400&key=AIzaSyARDffAihIXo7tYhNShT5G4NRJQV99wqnw");
        }
      },
    );
  }
